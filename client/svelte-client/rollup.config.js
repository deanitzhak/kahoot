...
export default {
	...
	plugins: [
		...
		replace({
			...
			'process.env.VITE_API_URL': JSON.stringify(process.env.VITE_API_URL || '172.18.212.76:5000')
		}),
		// Extract CSS to a separate file for performance
		css({ output: 'bundle.css' }),

		// Enable resolving of node_modules dependencies
		resolve({
			browser: true,
			dedupe: ['svelte'],
